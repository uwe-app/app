...
pub static REGION_INFO: Lazy<HashMap<Region, RegionInfo>> = Lazy::new(|| {
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.ap-east-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-ap-northeast-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.ap-northeast-2.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.ap-northeast-3.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.ap-south-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-ap-southeast-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-ap-southeast-2.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.ca-central-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.eu-central-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-eu-west-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.eu-west-2.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.eu-west-3.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.eu-north-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.eu-south-1.amazonaws.com"
                .to_string(),
            zone_id: None,
        },
    );
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.me-south-1.amazonaws.com"
                .to_string(),
            zone_id: None,
        },
    );
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-sa-east-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-us-east-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.us-east-2.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-us-west-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-us-west-2.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.us-gov-east-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website-us-gov-west-1.amazonaws.com"
                .to_string(),
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.cn-north-1.amazonaws.com.cn"
                .to_string(),
            zone_id: None,
        },
    );
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.cn-northwest-1.amazonaws.com.cn"
                .to_string(),
            zone_id: None,
        },
    );
    ...
    m.insert(
        ...
        RegionInfo {
            ...
            s3_endpoint_suffix: "s3-website.af-south-1.amazonaws.com"
                .to_string(),
